...
public class EnergyBillance
{
    public static EnergyBillance loadMeasures(Date from, Date to, Flat flat, Tariff tariff, boolean eletricity, int deposit)
    {
        ...
        if (m.nearestFrom == null || m.nearestTo == null)
        {
            return null;
        }
        try
    ...
    public ExtendedServicesTableModel getExtendedServicesTableModel()
    {
    ...
    public class ServicesTableModel extends AbstractTableModel
    {
        ...
        {
            ResourceBundle.getBundle("billance/Services").getString("serviceName"),
    ...
    public class HeatTableModel extends AbstractTableModel
    {
        ...
        private final String[] columnNames =
        {
            ResourceBundle.getBundle("billance/Services").getString("heatFrom"),
    ...
    public class SummaryTableModel extends AbstractTableModel
    {
        ...
        private final String[] columnNames =
        {
            ResourceBundle.getBundle("billance/Services").getString("summaryName"),
    ...
    public class ExtendedServicesTableModel extends AbstractTableModel
    {
        ...
        public ExtendedServicesTableModel()
        {
        }
